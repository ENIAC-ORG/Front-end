...
const Testresult = () => {
  ...
  return (
    <>
      <NavBar_SideBar />
      <div className="prof_body" onLoad={GetTestResult}>
        <div className="prof_Box pb-4" style={{ minWidth: "300px",width:"90%" }}>
          <link
                  ...
                  <div className="patient-panel-res">
                    <div className="col col-md-5 col-s-12 patient-panel-res_card">
                      ...
                      {results?.glasserTest == null ? (
                        <h5 className="my-5">
                          نتیجه ای برای مشاهده وجود ندارد
                        </h5>
                      ) : (
                        <ul
                          style={{ listStyleType: "none", lineHeight: "49px" }}
                        >
                          <li>
                            <IoHeart
                            ...
                            />
                            <span>عشق</span>:
                            {toPersianDigits(`${results.glasserTest.love}`)}
                          </li>
                          <li>
                            <GiPlantRoots style={{ color: "green" }} />
                            <span>بقا</span>:
                            {toPersianDigits(`${results.glasserTest.survive}`)}
                          </li>
                          <li>
                            <GiFreedomDove style={{ color: "blue" }} />
                            <span>آزادی</span>:
                            {toPersianDigits(`${results.glasserTest.freedom}`)}
                          </li>
                          <li>
                            <GiStrong style={{ color: "brown" }} />
                            <span>قدرت</span>:
                            {toPersianDigits(`${results.glasserTest.power}`)}
                          </li>
                          <li>
                            <GiLaserSparks style={{ color: "#B341EB" }} />
                            <span>سرگرمی</span>:
                            {toPersianDigits(`${results.glasserTest.fun}`)}
                          </li>
                        </ul>
                      )}
                    </div>
